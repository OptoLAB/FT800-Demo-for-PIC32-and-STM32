...
#define D5_LED_IO TRISEbits.TRISE0=0
#define D6_LED_IO TRISEbits.TRISE1=0
#define D5_LED(bit) LATEbits.LATE0=bit 
#define D6_LED(bit) LATEbits.LATE1=bit 
//--------------------------------------
...
//interrupt 
void __ISR(_EXTERNAL_0_VECTOR, IPL7SOFT) EXTI0_ISR(void){
    touched = 1;
    IFS0bits.INT0IF = 0;
}
...
{ 
    ...
    D5_LED(1); D6_LED(1);
    delay_ms(1000);
    DATA_LED(0); STAT_LED(0); // STAT is used as SCK2
    D5_LED(0); D6_LED(0);
